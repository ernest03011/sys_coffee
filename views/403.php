...
<main class="grid place-items-center bg-white px-3 py-6 sm:py-32 lg:px-4">
  <div class="text-center">
    <p class="text-base font-semibold text-yellow-950">403</p>
    <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Access Forbidden</h1>
    <p class="mt-6 text-base leading-7 text-gray-600">You tried to access a page you did not have prior authorization for.</p>
