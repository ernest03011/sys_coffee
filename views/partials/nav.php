<div class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="flex lg:hidden">
        <button type="button" id="openNavModal" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <?php if(isset($_SESSION['user']['email'])) : ?>    
          <a href="/membership" class="text-sm font-semibold leading-6 text-gray-900">Membership</a>
        <?php endif; ?>
      </div>
    ...
    <div class="lg:hidden" id="myModal" role="dialog" aria-modal="true">
      ...
      <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        ...
        <div class="flex items-center justify-between">
          ...
          <!-- Close button - X -->
          <button type="button" id="closeNavModal" class="-m-2.5 rounded-md p-2.5 text-gray-700">
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <?php if(isset($_SESSION['user']['email'])) : ?>    
                <a href="/recipes" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Recipes</a>
              <?php endif; ?>
              ...
              <?php if(isset($_SESSION['user']['email'])) : ?>    
                <a href="/membership" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Membership</a>
              <?php endif; ?>
            </div>
            <?php if(! isset($_SESSION['user']['email'])) : ?>    
              <div class="py-6">
